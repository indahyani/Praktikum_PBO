...
public class ControllerLaundry {
    ...
    public ControllerLaundry(ModelLaundry modellaundry, ViewLaundry viewlaundry) {
        ...
        viewlaundry.btnTotalPanel.addActionListener(new ActionListener() {
            @Override
         public void actionPerformed(ActionEvent e) {
                int hargaKategori=0;
                String agama = viewlaundry.getAgama();
                ...
                if (agama.equalsIgnoreCase("Cuci")){
                    hargaKategori = 4000;
                } else if(agama.equalsIgnoreCase("Cuci Setrika")) {
                    hargaKategori = 6000;
                } else if(agama.equalsIgnoreCase("Express 1 jam")){
                    hargaKategori = 24000;
                } else if(agama.equalsIgnoreCase("Express 1 hari")){
                    hargaKategori = 12000;
                }

                
                totalBayar = (int) hargaKategori*Integer.parseInt(berat);
                System.out.println(totalBayar);
                viewlaundry.lTbayar.setText(""+totalBayar);
            }
        });
    }
