...
public class ViewLaundry extends JFrame {
    ...
    ModelLaundry dataTotal = new ModelLaundry();
...
//    JTextField tfKembalian = new JTextField();
    ...
    Object namaKolom[] = {"Kode", "Nama", "Jenis Kelamin", "Alamat", "Katerogi Cuci","Berat","Bayar"}; //membuat kolom dalam array
